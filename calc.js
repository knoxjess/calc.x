...
function button_number(button) {
    ...
    operation_history = document.getElementById("operation_history");
...
// change the sign of the number currently on screen
function plus_minus(){
    box = document.getElementById("box");
